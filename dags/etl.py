...
#tasks: 1)fetch amazon data (extract) 2) clean data (transform ) 3)create and store data in the table on postgress(load)
#operators: here, we are using python operator and PostgressOperator 
#hooks
#dependencies
...
# Task to create the books table (load)
...
# Task to insert the fetched data into the PostgreSQL table
